...
% 	ok=0;
 ...
 % thisIm= morphvec2image(vec, w, h);
           % imwrite(thisIm,['C:\Users\Alan Admin\Desktop\samples\' num2str(i) '.bmp'],'bmp');
            %pic(((rows-1)*h)+1:rows*h, ((cols-1)*w)+1:cols*w, :) =thisIm.*255;
