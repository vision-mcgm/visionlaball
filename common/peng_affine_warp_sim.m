% Nonreflective siminarity transformation for an image given the control
% points in both source and target images.
%
%   Input:
...
%
% Peng Li 28-05-2010
function ImgOut = peng_affine_warp_sim(ImgIn, SourcePoints, TargetPoints)
...
TRANSMX = cp2tform(FromPoints, ToPoints, 'nonreflective similarity');
